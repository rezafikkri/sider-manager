...
export default function AdvancedConfigurationButton() {
  ...
  return (
    <section className="shadow-lg rounded-2xl flex-1 ms-1.5">
      <button className="btn bg-green-500 hover:bg-green-400 font-bold text-xl w-full px-4 py-5 rounded-2xl active:scale-[0.96] text-d-bg flex justify-center items-center">
