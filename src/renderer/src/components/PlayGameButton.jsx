...
export default function PlayGameButton() {
  ...
  return (
    <section className="col-span-2 mb-5">
      <button
        className="bg-green-500 hover:bg-green-400 font-bold text-xl rounded-2xl px-4 py-6 transition-all duration-[0.3s] active:scale-[0.96] shadow-lg text-d-bg flex justify-center items-center w-full"
