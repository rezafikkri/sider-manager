  ...
  return (
    <section className="p-10 rounded-lg border-4 border-d-bg-light bg-d-input-bg mb-5 mt-5 flex items-center" data-testid="addon-initialization-file">
      ...
      <button
        onClick={onRemove}
        type="button"
        className="btn active:not-disabled:scale-[0.96] rounded-lg text-sm px-2 py-1.5 bg-d-bg-light text-gray-400 hover:text-white hover:bg-red-700 transition-colors duration-300 disabled:outline-0 disabled:bg-d-alert-bg-hover disabled:text-gray-400"
        disabled={isLoading}
