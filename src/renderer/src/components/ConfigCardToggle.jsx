...
function ConfigCardToggle({
  ...
  return (
    <section className={`flex items-center ${mb} [&_code]:bg-indigo-950 [&_code]:p-1 [&_code]:py-0.5 [&_code]:rounded [&_code]:hover:bg-indigo-900 hover:bg-indigo-950 px-3 py-1.5 rounded-lg`}>
