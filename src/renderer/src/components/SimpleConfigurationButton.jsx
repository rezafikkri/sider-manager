  ...
  return (
    <section>
      <div className="shadow-lg rounded-t-3xl rounded-b-2xl">
        <button
          className="bg-indigo-700 hover:bg-indigo-600 font-bold text-xl w-full px-3 py-4 rounded-t-3xl outline outline-transparent focus:outline-offset-2 focus:outline-indigo-700 transition-colors duration-100"
