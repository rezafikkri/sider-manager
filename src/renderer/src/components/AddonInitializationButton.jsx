...
export default function AddonInitializationButton() {
  ...
  return (
    <section className="col-span-2 mb-4">
      <button
        className="shadow-lg bg-green-500 font-bold text-xl w-full px-4 py-5 rounded-2xl hover:bg-green-400 transition-all duration-[0.3s] text-d-bg active:scale-[0.96]"
      ...
      <small className="block text-white/70 text-left text-xs flex items-center mt-2">
        ...
        <span>{translate(locale, 'addonInitializationBtn.smallText', resources)}</span>
      </small>
    </section>
  );
}
