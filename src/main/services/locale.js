...
const resources = {
  ...
  en: {
    ...
    modalWithSimpleConfigForm: {
      ...
      errorAlertMsg: 'ML Manager wrong. Make sure after directory name is common directory (Reza Fikkri\\common) and make sure in common directory no .cpk file!',
      successAlertMsg: 'ML Manager successfully added.',
      directoryLabelText: 'Directory',
      directoryInputPlaceholder: 'Enter the directory',
      directoryBtnText: 'Choose',
      directorySmallText: 'Please choose new ML Manager location directory that you want to add.',
      nameLabelText: 'Name',
